...
Tags: events, listing, venue, event calendar, wedding, seminar, presentation, event schedule, iCal, Google Calendar, event management
...
== Description ==
The plugin is available in English, Russian(Русский), German(Deutsch) and Polish(Polski).
...
9. **Event List View** - Front-end list view of events.
10. **Event Grid View** - Front-end grid view of events.
11. **Event Detail Page** - Event detail/single page. Event details related to event location and its organizer are placed on it.
12. **Event Calendar** - Front-end view of the calendar with upcoming events listing.

== Upgrade Notice ==

= 1.3.3 =
 1.3.3 is a minor update with the fixing of translation phrases in .pot files as well as hard-coded strings in plugin.