                            ...
                            <ul class="form-elements">
                                ...
                                <li class="element-field">
                                    ...
                                    <?php } if (1 == $segment_size) { ?>
                                        <div id="itemRows">
                                            <input type="text" name="custom[add_seg][]" value="<?php echo trim(esc_attr($seg_array[0])); ?>">
                                        </div>  
                                        <?php
                                    } else {
                                        $row_count = 1;
                                        ...
                                        <div id="itemRows"> 
                                            <?php foreach ($seg_array as $key => $value) { ?>
                                                <p id="rowNum<?php echo intval($row_count); ?>">
                                                    ...
                                                    <input type="button" id="<?php echo intval($row_count); ?>" value="<?php esc_html_e('Remove', 'simple-event-planner'); ?>" onclick="removeRow('<?php echo intval($row_count); ?>');">
                                                </p>
                                                <?php
                                                $row_count++;
                                            }
                                    ...
                                    <?php } ?>
                                    <input onclick="addRow('<?php echo esc_js('itemRows');?>');" type="button" value="<?php esc_html_e('Add more', 'simple-event-planner'); ?>">
                                </li>
                            </ul>
    ...
    public static function sep_save_event_listing_meta($post_id) {
        ...
        if (isset($_POST['custom'])) {
            foreach ($_POST['custom'] as $key => $value) {
                if ( sanitize_text_field($key) !== "add_seg" ) {
