...
class Simple_Event_Planner_Public {
    ...
    public function enqueue_scripts() {
        ...
        wp_register_script($this->simple_event_planner . '-google-api', 'http://maps.googleapis.com/maps/api/js?'. esc_attr($api_key) .'v=3.24&libraries=places', '', '3.24', TRUE);
        ...
        wp_register_script($this->simple_event_planner . '-jquery-event-calendar-min', plugin_dir_url(__FILE__) . 'js/jquery.eventCalendar.min.js', '', '0.66', TRUE);
        ...
        wp_localize_script($this->simple_event_planner . '-frontend', 'sep_counter', array(
